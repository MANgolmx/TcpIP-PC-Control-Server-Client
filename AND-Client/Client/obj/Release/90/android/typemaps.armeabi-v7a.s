...
java_name_width:
	...
	.p2align	2
map_modules:
	.byte	0x41, 0x63, 0xf6, 0x4b, 0x51, 0x26, 0x5e, 0x45, 0x83, 0x30, 0x55, 0xfd, 0x72, 0xbd, 0x98, 0x40	@ module_uuid: 4bf66341-2651-455e-8330-55fd72bd9840
	.long	0xa3	@ entry_count
	.long	0x54	@ duplicate_count
	...
	.byte	0x75, 0x80, 0x17, 0x13, 0x16, 0x68, 0xc2, 0x4c, 0x9a, 0x28, 0xe8, 0x6a, 0xbd, 0x35, 0xe0, 0x9	@ module_uuid: 13178075-6816-4cc2-9a28-e86abd35e009
	.long	0x5	@ entry_count
	.long	0x0	@ duplicate_count
	.long	.L.module1_managed_to_java	@ map
	.long	0	@ duplicate_map
	.long	map_aname.1	@ assembly_name: Client
	.long	0x0	@ image
	.long	0x0	@ java_name_width
	.long	0x0	@ java_map
